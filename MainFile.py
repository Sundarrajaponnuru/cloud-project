...
print("-------------------------------------------------------------")
print("Prediction ---> Work Distributed           ")
print("-------------------------------------------------------------")
print()

# === SERVER CAPACITY ===

servers=int(input("How Many Servers which we have?:"))

server_capacity=[]

for i in range(servers):
    size=int(input("Enter the capacity for server (in kbs):"))
    server_capacity.append(size)    

#server_capacity.sort()
#server_capacity.sort(reverse=True)
#
#print(server_capacity)


prediction_ser_cap=0
for i in server_capacity:
...
no_of_process=int(input("Enter the No.Of Process:"))
capacity=[]

for i in range(0,no_of_process): 
    
    size=int(input("Enter the capacity (in kbs):"))
...
if prediction_cap>prediction_ser_cap:
    ...
    final=prediction_cap/len(servers)
    
    servers=int(input("How Many Servers which we need?:"))
...
#    server_capacity=[]
    ...
    prediction_ser_cap_extra=0
    for i in server_capacity:
        prediction_ser_cap_extra=prediction_ser_cap_extra+i
        
    final_ser_cap=prediction_ser_cap_extra+prediction_ser_cap
...
#    print("Need Servers")
    ...
    print("Process ",i," have",server_capacity[i],"kbs", "this allocates to ","Server",i)
